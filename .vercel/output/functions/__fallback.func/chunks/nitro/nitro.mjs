...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "10285df6-f71e-4cb7-a4ff-d8d676e03672",
...
const _lazy_buBDYi = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_buBDYi, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_buBDYi, lazy: true, middleware: false, method: undefined }
];
